...
export const ContactEvents = ['contact.created', 'contact.updated', 'contact.deleted'] as const;
...
export type WebhookPayloadData<TType extends WebhookEventType> = WebhookEventPayloadMap[TType];
